        ...
        <div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-between w-[35%]">
              <div className="flex">
                <Avatar
                  src="hhttps://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.veryicon.com%2Ficons%2Finternet--web%2Fprejudice%2Fuser-128.html&psig=AOvVaw2SjdA7ZTdmbM582YoVgu2y&ust=1718202352189000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCMCMitrg04YDFQAAAAAdAAAAABAE"
                  size={35}
                  round={true}
                />
            ...
            <div className="flex items-center w-[40%] justify-between mt-2">
              <div className="flex items-center cursor-pointer bg-black text-white px-4 py-2 rounded-full ">
                <AiOutlineLike size="20px" className="mr-5 active:bg-white" />
                <AiOutlineDislike size="20px" className="active:bg-white" />
              </div>
              <div className="flex items-center cursor-pointer bg-black text-white px-4 py-2 rounded-full">
                <PiShareFatLight size="20px" className="mr-2 active:bg-white" />
                <span>Share</span>
              </div>
              <div className="flex items-center cursor-pointer bg-black text-white px-4 py-2 rounded-full">
                <GoDownload className="active:bg-white" />
                <span>Download</span>
              </div>
            </div>
          </div>
